...
import { EditorView, drawSelection, dropCursor, highlightSpecialChars, keymap, placeholder, rectangularSelection, } from '@codemirror/view';
import { activeFormats, insertCodeBlock, insertHorizontalRule, insertLink, insertTable, setHeading, toggleBold, toggleBulletList, toggleHighlight, toggleInlineCode, toggleItalic, toggleNumberedList, toggleQuote, toggleStrikethrough, toggleTodo, } from './commands';
...
import { tagCompletion } from './tagComplete';
...
export function slateSetup(options) {
    return [
        history(),
        drawSelection(),
        dropCursor(),
        ...
        EditorView.updateListener.of((update) => {
            ...
            if (update.startState.doc !== update.state.doc ||
